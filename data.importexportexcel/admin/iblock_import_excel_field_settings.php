...
{
	$arExtra = array();
	\CKDAImportExtrasettings::HandleParams($arExtra, array(array(array('CONVERSION'=>$_POST['CONVERSION'], 'EXTRA_CONVERSION'=>$_POST['EXTRA_CONVERSION']))));
	...
	$arConv = array_map(create_function('$c', '$c["CONV_TYPE"]=0; return $c;'), $arConv);
	$arExtraConv = array_map(create_function('$c', '$c["CONV_TYPE"]=1; return $c;'), $arExtraConv);

...
if(!class_exists('CDataImpExpExcelRunner'))
{
	class CDataImpExpExcelRunner
	{
		protected static $moduleId = 'data.importexportexcel';
...
$moduleId = CDataImpExpExcelRunner::GetModuleId();

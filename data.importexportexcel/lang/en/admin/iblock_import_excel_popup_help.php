...
$MESS["KDA_IE_FAQ_ANS_CRON"] = "On the pages of the module in the upper right corner there is a green button \"Configure cron\". <br>
	...
	<b><i>/home/bitrix/yoursite.com/bitrix/php_interface/include/data.importexportexcel/cron_frame.php 0</i></b> - directly executable script. If you have hosting in nastroykh item type \"Run php script\", in line with the script will need to insert only that part of the line. Here, \"0\" at the end - this import profile identifier.<br>
	<b><i>>/home/bitrix/yoursite.com/bitrix/php_interface/include/data.importexportexcel/logs/0.txt</i></b> - the path to the import logs. Without specifying this file, it will be difficult for you to further track the results of imports by cron.<br><br>				

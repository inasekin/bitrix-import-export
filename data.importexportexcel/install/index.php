...
if (class_exists('data_importexportexcel')) return;

class data_importexportexcel extends CModule {

	var $MODULE_ID = 'data.importexportexcel';
	...
	public function __construct() {
		...
		$this->PARTNER_NAME = GetMessage("DATA_PARTNER_NAME");
		$this->PARTNER_URI = 'https://inasekin.github.io/';

		$this->MODULE_NAME = GetMessage('DATA_IMPORTEXPORTEXCEL_MODULE_NAME');
		$this->MODULE_DESCRIPTION = GetMessage('DATA_IMPORTEXPORTEXCEL_MODULE_DESCRIPTION');
	}

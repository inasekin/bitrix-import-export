...
if($USER->IsAdmin())
{
	...
	$tabControl = new CAdminTabControl("dataImportexportexcelTabControl", $aTabs, true, true);
	...
	$tabControl->Begin();
	?>
	<form method="POST" action="<?echo $APPLICATION->GetCurPage()?>?lang=<?echo LANGUAGE_ID?>&mid_menu=1&mid=<?=$moduleId?>" name="data_importexportexcel_settings">
